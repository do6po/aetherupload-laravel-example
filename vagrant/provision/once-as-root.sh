...
mysql -uroot -proot <<< "CREATE DATABASE big_file_uploader CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
mysql -uroot -proot <<< "CREATE DATABASE big_file_uploader_tests CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
echo "Done!"
