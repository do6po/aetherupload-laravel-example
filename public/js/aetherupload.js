...
someCallback = function(){
    $('#result').append(
        '<p> Исходное имя файла: <span>'+this.fileName+'</span> Размер файла: <span>'+parseFloat(this.fileSize / (1000 * 1000)).toFixed(2) + 'MB'+'</span> | Имя хранилища файлов: <span>'+this.savedPath.substr(this.savedPath.lastIndexOf('/') + 1)+'</span></p>'
    );
}
